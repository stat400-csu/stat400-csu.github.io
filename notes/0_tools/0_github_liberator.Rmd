...
1. Click top right Home button > Open project > STAT400 > STAT400.Rproj
...
1. Share your homeworks project with the instructor and grader.

    a. Click top right Home button > Open project > STAT400 > STAT400.Rproj. Click homeworks/homeworks.Rproj to open the homeworks project.

    a. Click the drop down on the project (top right side) > Share Project...
    
        ```{r, echo=FALSE, out.width="25%"}
        knitr::include_graphics("../images/share_project.png")
        ```
      
    a. Click the drop down and add "stat400instructors" to your project.
    
        ```{r, echo=FALSE, out.width="25%"}
        knitr::include_graphics("../images/share_dropdown.png")
        ```
